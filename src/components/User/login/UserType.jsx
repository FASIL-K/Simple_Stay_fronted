          ...
          <img src={logoImage} alt="Logo" className="mx-auto " />
            ...
            <div className="bg-white shadow-2xl rounded p-8 border border-b-transparent p-17 ">
              ...
              <div className="flex justify-between">
                <button
                  className="bg-yellow-300 hover:bg-yellow-400 focus:outline-none focus:shadow-outline-yellow active:bg-yellow-500 text-white font-bold py-2 px-4 rounded"
